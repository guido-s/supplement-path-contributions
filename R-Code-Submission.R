...
netgraph(net1, seq = "optimal", plastic = FALSE, col = "black")
##dev.off()
...
netgraph(net2, start = "prcomp", plastic = FALSE, 
  ...
  rescale.pointsize = id, points.max = 4, lwd.max = 4)
...
netgraph(net4, plastic = FALSE, seq = c("D", "E", "A", "B", "C"),
  ...
  rescale.pointsize = id, points.max = 4, lwd.max = 6,
...
netgraph(net4, plastic = FALSE, seq = c("D", "E", "A", "B", "C"),
  points = TRUE, col.points = c("red", 1, "red", 1, 1), col = 1,
  rescale.pointsize = id, points.max = 4,
...
## save(L1, file = "Linde2016-L1result.rda")

## L2 <-
##   netmeta:::contribution.matrix.ruecker.pseudoinv(net1, "common",
##                                                   verbose = TRUE)
## save(L2, file = "Linde2016-L2result.rda")

load(file = "Linde2016-shortestpath-result.rda")
load(file = "Linde2016-randomwalks-result.rda")
load(file = "Linde2016-L1result.rda")
load(file = "Linde2016-L2result.rda")
